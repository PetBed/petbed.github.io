...
export const INGREDIENTS_DATA = {
	pinot_noir: {name: "Pinot Noir Grapes", flavour: {sw: 15, ac: 25, tn: 15, bd: 20}},
	chardonnay: {name: "Chardonnay Grapes", flavour: {sw: 10, ac: 35, tn: 0, bd: 15}},
	cabernet: {name: "Cabernet Grapes", flavour: {sw: 5, ac: 15, tn: 40, bd: 35}},
	muscat: {name: "Muscat Grapes", flavour: {sw: 45, ac: 10, tn: 5, bd: 20}},
	hops: {name: "Fresh Hops"},
	barley: {name: "Craft Barley"},
	blackberry: {name: "Wild Blackberry", flavour: {sw: 15, ac: 15, tn: 30, bd: 25}},
	raspberry: {name: "Golden Raspberry", flavour: {sw: 20, ac: 25, tn: 5, bd: 10}},
	blueberry: {name: "Forest Blueberry", flavour: {sw: 15, ac: 20, tn: 15, bd: 20}},
	strawberry: {name: "Sweet Strawberry", flavour: {sw: 35, ac: 15, tn: 0, bd: 10}},
	elderberry: {name: "Bitter Elderberry", flavour: {sw: 5, ac: 20, tn: 35, bd: 25}},
