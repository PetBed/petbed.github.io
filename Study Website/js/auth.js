...
window.StudyApp = window.StudyApp || {};
	...
	function showPage(page) {
		const pages = { dashboard: dashboardPage, study: studyPage, tasks: tasksPage, flashcards: flashcardsPage, binder: binderPage, syllabus: syllabusPage };
		const navs = { dashboard: navDashboard, study: navStudy, tasks: navTasks, flashcards: navFlashcards, binder: navBinder, syllabus: navSyllabus };
