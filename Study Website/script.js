...
document.addEventListener("DOMContentLoaded", function () {
	...
	const modalDateHeadingEl = document.getElementById("modal-date-heading");
	const modalDateSubEl = document.getElementById("modal-date-sub");
	const modalTodayBadgeEl = document.getElementById("modal-today-badge");
	const modalEventsCountEl = document.getElementById("modal-events-count");
	const openAddEventBtn = document.getElementById("open-add-event-btn");
	const calendarAddEventPanel = document.getElementById("calendar-add-event-panel");
	const cancelAddEventBtn = document.getElementById("cancel-add-event-btn");
	const cancelAddEventX = document.getElementById("cancel-add-event-x");
	...
	const calendarTimelineScroll = document.getElementById("calendar-timeline-scroll");
	const timelineTimeLabels = document.getElementById("timeline-time-labels");
	const timelineHourRows = document.getElementById("timeline-hour-rows");
	const timelineEventsOverlay = document.getElementById("timeline-events-overlay");
	const timelineNowLine = document.getElementById("timeline-now-line");
	const timelineAllDaySection = document.getElementById("timeline-all-day-section");
	const timelineAllDayList = document.getElementById("timeline-all-day-list");
	const timelineEmptyState = document.getElementById("timeline-empty-state");
	const emptyStateAddBtn = document.getElementById("empty-state-add-btn");
	const todayMonthBtn = document.getElementById("today-month-btn");
	const openGcalModalBtn = document.getElementById("open-gcal-modal-btn");
	const gcalModal = document.getElementById("gcal-modal");
	const closeGcalModalBtn = document.getElementById("close-gcal-modal-btn");
	const closeGcalModalFooterBtn = document.getElementById("close-gcal-modal-footer-btn");
	const gcalStatusDot = document.getElementById("gcal-status-dot");
	const gcalGuideToggle = document.getElementById("gcal-guide-toggle");
	const gcalGuideContent = document.getElementById("gcal-guide-content");
	const gcalGuideIcon = document.getElementById("gcal-guide-icon");
	const gcalAddForm = document.getElementById("gcal-add-form");
	const gcalUrlInput = document.getElementById("gcal-url-input");
	const gcalNameInput = document.getElementById("gcal-name-input");
	const gcalSelectedColorInput = document.getElementById("gcal-selected-color");
	const gcalColorPicker = document.getElementById("gcal-color-picker");
	const gcalFormError = document.getElementById("gcal-form-error");
	const gcalCalendarsList = document.getElementById("gcal-calendars-list");
	const gcalEmptyCalendars = document.getElementById("gcal-empty-calendars");
	const gcalSyncAllBtn = document.getElementById("gcal-sync-all-btn");
	const gcalSyncAllIcon = document.getElementById("gcal-sync-all-icon");
	const gcalFileInput = document.getElementById("gcal-file-input");
	const gcalAutoSyncToggle = document.getElementById("gcal-auto-sync-toggle");
	...
	async function initializeApp() {
		...
		const populateSubjects = () => {
			const selects = [taskSubjectSelect, pomodoroSubjectSelect, filterSubjectEl, editTaskSubject, examSubjectInput, finalSubjectInput, eventSubjectSelect];
			selects.forEach((sel) => {
				if (!sel) return;
